...
import { Loader2, Building2, Users, Eye, EyeOff } from "lucide-react";
          ...
          {isDemoMode && (
            <div className="mt-4 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50 rounded-lg animate-pulse">
              <p className="text-sm text-amber-800 dark:text-amber-400 flex items-center justify-center gap-2 font-semibold">
                <span>🚀</span> Demo Mode: Backend not connected. Use demo
                credentials below.
              </p>
            </div>
          )}
        ...
        <Card className="border-none shadow-2xl bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl ring-1 ring-slate-200 dark:ring-slate-800">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    disabled={isLoading}
                    className="bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 focus:ring-blue-500 h-11 pr-10"
                  />
                  <button
                    type="button"
              ...
              <Button
                type="submit"
                className="w-full h-11 bg-blue-600 hover:bg-blue-700 transition-all shadow-lg shadow-blue-500/20"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
