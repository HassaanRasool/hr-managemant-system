...
import { Plus, Award, Target, TrendingUp, Users } from "lucide-react"
...
export function PerformanceManagement() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Exceeded targets</p>
          </CardContent>
        </Card>
      </div>
      ...
      <CreateAppraisalDialog open={showCreateDialog} onOpenChange={setShowCreateDialog} />
    </div>
  )
}
