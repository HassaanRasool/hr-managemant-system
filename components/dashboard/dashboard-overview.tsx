    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Welcome back, {user?.name || "User"}! Here&apos;s your HR system overview
        </p>
      </div>

      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="glass-card animate-fade-in-up delay-75">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {isLoading ? "..." : employees.length || stats.totalEmployees}
            </div>
            <p className="text-xs text-muted-foreground">+5 from last month</p>
          </CardContent>
        </Card>
        <Card className="glass-card animate-fade-in-up delay-150">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              Open Positions
            </CardTitle>
        ...
        <Card className="glass-card animate-fade-in-up delay-500">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">
              Training Sessions
            </CardTitle>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {isLoading ? "..." : trainings.length || stats.trainingSessions}
            </div>
